...
from wtforms import SubmitField, IntegerField, FloatField, TextAreaField, DateField, StringField, EmailField, SelectField
...
class EmployeeForm(FlaskForm):
    ...
    name = StringField(
        'Name',
        validators=[DataRequired(message="Employee name is required.")]
    )
