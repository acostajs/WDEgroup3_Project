...
def generate_schedule_route():
    ...
    try:
        ...
        if success:
            ...
            flash('New schedule generated successfully for the current month!', 'success')
        else:
            print("Scheduling function reported failure.")
            flash('Error generating schedule for the current month. Check application logs for details.', 'danger')
